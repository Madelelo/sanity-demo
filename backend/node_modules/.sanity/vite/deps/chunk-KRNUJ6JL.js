...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: commentsLocaleNamespace, resources: () => import("./resources-BxKucOVx-YQNNF2IM.js") });
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: structureLocaleNamespace, resources: () => import("./resources-B_y3iqGc-L6XUL7GT.js") });
...
var structureTool = definePlugin((options) => {
  ...
  return { name: "sanity/structure", document: { actions: (prevActions) => {
    ...
    icon,
    component: (0, import_react3.lazy)(() => import("./index-BV_8ds5h-XRDCNCYO.js")),
...
//# sourceMappingURL=chunk-KRNUJ6JL.js.map
